...
<div class=" row page-titles shadow-lg mx-0">
    ...
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{route('pagecreateresult')}}">Kết quả</a></li>
        </ol>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('storeresult')}}" method="POST">
                    ...
                    <button type="submit" style="margin-left: 400px; width:150px;height:50px;font-size: 20px;" class="btn  btn-primary">Lưu kết quả</button>
                </form>
            </div>
        </div>
    </div>
