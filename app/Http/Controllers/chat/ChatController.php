...
class ChatController extends Controller
{
    ...
    public function chat_admin()
    {
        ...
        return view('pages.chat.admin.index_Admin',compact('employees','Departments','contentchats','chatBoxs')); 
    }
    public function detail_admin($id)
    {
        $chatBoxs=chatbox::where('Id_ChatBox','=',$id)->get();
        $employees=nhanvien::all();
        return view('pages.chat.admin.detailchat',compact('employees','chats','contentchats','chatBoxs')); 
    }
    ...
    public function data(request $request,$id)
    {
        ...
        return view('pages.chat.loaddata',compact('chats','contentchats','chatBoxs')); 
    }
    public function datachatbox_admin()
    {
        ...
        return view('pages.chat.admin.loaddatachatbox',compact('chats','contentchats','chatBoxs')); 
    }
    public function datachatbox_user()
    {
        ...
        $chatBoxs=chatbox::where('NguoiTao','=',$info[0]->Id_NhanVien)
                        ...
                        ->orderBy('Id_ChatBox', 'DESC')
                        ->get();    
        return view('pages.chat.user.loaddatachatbox',compact('chats','contentchats','chatBoxs')); 
    }
    ...
    public function createchat_admin(request $request)
    {
        ...
        // return response()->json('nhanvien:'.$request->nhanvien.',chat:'.$request->idchat.',text:'.$request->text);
    }
    ...
    public function detailchat_user($id)
    {
        ...
        $chatBoxs=chatbox::where('Id_ChatBox','=',$id)->get();
        return view('pages.chat.user.detailchat',compact('contentchats','chatBoxs','employees')); 
    }
