...
class EmployeeController extends Controller
{
    ...
    {    
      ...
      return view('admin.employee.create', compact('levelofEmployees','employee','listdonvi','listchucvu','listtdchuyenmon','listtdtinhoc','listtdngoaingu','listchinhtri','listphanquyen','listchuyenmon','listbomon','listphongban'));
    } 
