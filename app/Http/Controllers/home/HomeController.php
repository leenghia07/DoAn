...
class HomeController extends Controller
{
    public function homeadmin()
    {
        ...
        return view('admin.home.index',compact('dateNow','timeKeepings','meettings','works','employees','departments'))->with('homeadmin','chào ');
    ...
    public function homeuser()
    {
      ...
      return view('user.home.index',compact('dateNow','documents','employeeOfDerpartment','employees','allMettings','meettings','UpdateStateUser','calendarWork'));
    }
}
