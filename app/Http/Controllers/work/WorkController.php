...
class WorkController extends Controller
{
    public function admin()
    {
        ...
        return view('pages.work.index_Admin',compact('checkadmin','Departments','dateNow','works','workEmployees','employees'));
    }
    public function user()
    {
        ...
        return view('pages.work.index_User',compact('checkemployees','checkManager','timeNow','managerDerpartment','works','employeeOfDerpartments','weekStartDate','employees','weekEndDate','employeeLaudatory','employeeDiscipline'));
    }
